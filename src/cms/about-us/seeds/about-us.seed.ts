  ...
  async seed(): Promise<void> {
    ...
    if (existingAboutUs) {
      ...
      const needsTeamMembers =
        !existingAboutUs.teamSection?.members ||
      ...
      if (needsTeamMembers) {
        ...
        existingAboutUs.teamSection = {
          isActive: true,
          title:
            existingAboutUs.teamSection?.title || 'Meet Our Expert Instructors',
          subtitle: existingAboutUs.teamSection?.subtitle || 'Our Team',
          description:
            existingAboutUs.teamSection?.description ||
            'Our dedicated team of aviation professionals brings years of experience and passion to help you achieve your flight training goals.',
