...
async function fixContactData() {
    ...
    try {
        ...
        if (contacts.length === 0) {
            ...
            console.log(`📝 Found ${contacts.length} contact(s). Updating with proper data...`);
                ...
                if (needsUpdate) {
                    ...
                    const updateData = {
                        ...
                        formSection: {
                            ...
                            title: contact.formSection?.title || 'Ready to Start Your Aviation Journey?',
                            image: contact.formSection?.image || '/icons/support.svg',
                            imageAlt: contact.formSection?.imageAlt || 'Customer support illustration',
                        },
                        mapSection: {
                            embedUrl: contact.mapSection?.embedUrl ||
                        ...
                        seo: {
                            ...
                            description: contact.seo?.description || 'Get in touch with Personal Wings for all your aviation needs',
                            keywords: contact.seo?.keywords || 'contact, aviation, personal wings',
                        },
