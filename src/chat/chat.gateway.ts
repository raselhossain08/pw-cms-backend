...
export class ChatGateway implements OnGatewayConnection, OnGatewayDisconnect {
  ...
  constructor() {} // private readonly aiService: AIService, // private readonly chatService: ChatService, // Inject your services here
  ...
  handleDisconnect(client: Socket) {
    ...
    for (const [
      conversationId,
      sockets,
    ] of this.conversationSockets.entries()) {
  ...
  private async handleAIResponse(
    ...
    try {
      ...
      this.logger.log(
        `AI processing message in conversation ${conversationId}`,
      );
      ...
      const aiResponseText = this.generateMockAIResponse(
        userMessage,
        aiConfig.tone,
      );
  ...
  private generateMockAIResponse(userMessage: string, tone: string): string {
    ...
    const responses = {
      professional:
        'Thank you for your inquiry. I will assist you with that request.',
      friendly: "Hey there! 😊 I'd be happy to help you with that!",
      casual: 'Sure thing! Let me help you out with that.',
      formal:
        'I acknowledge your request and will provide assistance accordingly.',
    };
