...
import { ExportInstructorsDto, InstructorStatus } from './dto/instructor-admin.dto';
...
export class AdminInstructorsService {
    ...
    async bulkDeleteInstructors(ids: string[]) {
        ...
        if (ids.length > 100) {
            throw new BadRequestException('Cannot delete more than 100 instructors at once');
        }
