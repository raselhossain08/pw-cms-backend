...
export class IntegrationsController {
  ...
  @Post('webhooks')
  @Roles(UserRole.ADMIN, UserRole.SUPER_ADMIN)
  async updateWebhooks(@Body() config: { url: string; events: string[] }) {
    return await this.integrationsService.updateSystemWebhooks(config);
  }

  @Get('webhooks')
  @Roles(UserRole.ADMIN, UserRole.SUPER_ADMIN)
  async getWebhooks() {
    return await this.integrationsService.getSystemWebhooks();
  }
}
